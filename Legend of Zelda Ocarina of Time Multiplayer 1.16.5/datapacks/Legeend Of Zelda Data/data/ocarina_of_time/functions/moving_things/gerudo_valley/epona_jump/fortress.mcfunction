...
execute if entity @s[scores={timer=1..10}] run tp @s 382 73 2041 90 0
...
execute if entity @s[scores={timer=41}] run tp @s 368 73 2041 90 0
execute if entity @s[scores={timer=41}] run tp @a 369 73 2041 90 0
execute if entity @s[scores={timer=41..}] run tag @a remove JumpFortress
