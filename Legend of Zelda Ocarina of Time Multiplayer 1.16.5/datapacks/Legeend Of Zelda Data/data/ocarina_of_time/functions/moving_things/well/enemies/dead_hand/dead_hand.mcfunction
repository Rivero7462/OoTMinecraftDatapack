...
execute unless entity @s[tag=Run] if entity @s[scores={timer=1}] run tp @s ~ 60 ~
...
execute unless entity @s[tag=Run] if entity @s[scores={timer=95..100}] unless entity @s[scores={lifetime=300..}] run scoreboard players set @s timer 69
...
execute if entity @s[scores={timer=156}] run particle minecraft:block minecraft:dirt ~ 60 ~ 1 2 1 1 500 normal
...
execute if entity @s[scores={timer=158}] run tp @s 27 52 1363
