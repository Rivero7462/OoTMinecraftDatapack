...
execute if entity @s[scores={lifetime=1}] run fill 849 88 -1165 849 88 -1165 minecraft:white_shulker_box
...
execute if entity @s[scores={lifetime=70}] run fill 842 91 -1192 842 91 -1192 minecraft:redstone_block
