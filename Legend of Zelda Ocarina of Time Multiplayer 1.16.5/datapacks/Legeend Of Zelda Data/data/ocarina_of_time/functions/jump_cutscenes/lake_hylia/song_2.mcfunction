execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run fill 1423 66 2685 1423 66 2685 minecraft:barrier
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run fill 1422 66 2684 1422 66 2684 minecraft:barrier
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run fill 1423 66 2683 1423 66 2683 minecraft:barrier
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run fill 1424 66 2684 1424 66 2684 minecraft:barrier
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run fill 1423 68 2685 1423 68 2685 minecraft:barrier
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run fill 1422 68 2684 1422 68 2684 minecraft:barrier
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run fill 1423 68 2683 1423 68 2683 minecraft:barrier
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run fill 1424 68 2684 1424 68 2684 minecraft:barrier
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run scoreboard players set @s text 0
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run tp @a 1423 66 2684
...
execute if entity @s[tag=WrongSong] run fill 1422 66 2683 1424 68 2685 minecraft:air
...
execute if entity @s[tag=Part2] if entity @a[scores={click=10..}] run fill 1422 66 2683 1424 68 2685 minecraft:air
