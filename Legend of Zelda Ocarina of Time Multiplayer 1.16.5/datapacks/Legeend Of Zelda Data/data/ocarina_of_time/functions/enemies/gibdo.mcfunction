...
execute if entity @a[distance=..200] unless entity @s[tag=Attack] unless block ~ ~ ~ minecraft:air run tp @s ~ ~.5 ~

#Scared
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] if entity @s[scores={timer=10}] run tag @s add Scared
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] if entity @s[scores={timer=10}] run function ocarina_of_time:items/ocarina/ocarina_3
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] at @a if entity @s[scores={timer=10}] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["Scared"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] if entity @s[scores={timer=10..20}] run effect give @a minecraft:levitation 1 255 true
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] if entity @s[scores={timer=10..20}] run effect give @a minecraft:slowness 1 1 true
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] at @e[type=area_effect_cloud,tag=Scared] if entity @s[scores={timer=10..40}] run tp @a ~ ~ ~
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] if entity @s[scores={timer=10..40}] run data merge entity @s {Invulnerable:1b}
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] if entity @s[scores={timer=40}] run data merge entity @s {Invulnerable:0b}
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] if entity @s[scores={timer=81}] run kill @e[type=area_effect_cloud,tag=Scared]
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] if entity @s[scores={timer=81}] run tag @s remove Scared
execute unless entity @a[scores={ResetHealth=1..}] unless entity @s[tag=Stun] unless entity @s[tag=Eat] if entity @s[scores={timer=81..}] run scoreboard players set @s timer 0
...
#Stun
execute if entity @a[distance=..15] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_13",Count:1b}]}] run tag @s add Stun
