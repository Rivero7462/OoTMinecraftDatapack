...
#Walls
execute unless entity @s[tag=Die] as @e[type=zombie,tag=Flat] at @s unless block ~ ~1 ~.3 minecraft:air run data merge entity @s {Invulnerable:1b}
execute unless entity @s[tag=Die] as @e[type=zombie,tag=Flat] at @s unless block ~ ~1 ~-.3 minecraft:air run data merge entity @s {Invulnerable:1b}
execute unless entity @s[tag=Die] as @e[type=zombie,tag=Flat] at @s unless block ~.3 ~1 ~ minecraft:air run data merge entity @s {Invulnerable:1b}
execute unless entity @s[tag=Die] as @e[type=zombie,tag=Flat] at @s unless block ~-.3 ~1 ~ minecraft:air run data merge entity @s {Invulnerable:1b}
execute unless entity @s[tag=Die] as @e[type=zombie,tag=Flat] at @s if blocks ~-.4 ~1 ~-.4 ~.4 ~1 ~.4 902 90 -625 all unless entity @s[scores={HoverTimer=1..}] run data merge entity @s {Invulnerable:0b}
...
#Hurt
execute unless entity @s[tag=Die] if entity @e[type=zombie,tag=Flat,nbt={HurtTime:10s}] run tag @s add Hide
...
execute unless entity @s[tag=Die] if entity @s[scores={HoverTimer=10}] run data merge entity @s {ArmorItems:[{},{},{},{id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:84}}],HandItems:[{},{}]}
execute unless entity @s[tag=Die] if entity @s[scores={HoverTimer=160}] run data merge entity @s {ArmorItems:[{},{},{},{id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:82}}],HandItems:[{},{}]}
...
#Kill
execute unless entity @e[type=zombie,tag=Flat] if entity @s[tag=!Die] run scoreboard players set @s timer 0
execute unless entity @e[type=zombie,tag=Flat] if entity @s[tag=!Die] run tag @s add Die
