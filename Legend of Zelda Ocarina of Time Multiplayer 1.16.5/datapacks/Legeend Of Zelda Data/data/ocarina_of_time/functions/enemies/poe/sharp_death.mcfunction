...
execute if entity @s[scores={timer=1}] run data merge entity @s {ArmorItems:[{},{},{},{id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:83}}],HandItems:[{},{}]}
execute if entity @s[scores={timer=1}] unless block 1643 75 1946 minecraft:gold_block unless block 1643 75 1945 minecraft:gold_block run scoreboard players set @s text 1
execute if entity @s[scores={timer=1}] unless block 1643 75 1946 minecraft:gold_block if block 1643 75 1945 minecraft:gold_block run scoreboard players set @s text 2
