...
tag @s add StopTime
#Skulltula
execute unless entity @e[type=zombie,tag=Skulltula19] run summon minecraft:zombie 1032 38 1900 {PersistenceRequired:1b,Tags:["Skulltula19","Skulltula","Invisible"],Rotation:[0f],ArmorItems:[{},{},{},{id:brown_mushroom_block,Count:1b}],DeathLootTable:"ocarina_of_time:entities/skulltula",Health:6,Attributes:[{Name:"generic.max_health",Base:6},{Name:"generic.attack_damage",Base:1},{Name:"generic.movement_speed",Base:0.0}],Silent:1,ArmorDropChances:[0f,0f,0f,0f]}
tag @a add Indoors
tp @s 1032 36 1909 180 ~
