...
#Requiem of Spirit
execute if entity @s[x=415,y=53,z=480,dx=0,dz=0] run function ocarina_of_time:teleports/desert_colossus/from_requiem

#Great Fairy Fountain
execute if entity @s[x=453,y=61,z=482,dx=2,dz=1] run function ocarina_of_time:teleports/desert_colossus/great_fairy_fountain/inside
execute if entity @s[x=458,y=37,z=506,dx=4,dz=3] run function ocarina_of_time:teleports/desert_colossus/great_fairy_fountain/outside

#Grotto 1
execute if entity @s[x=448,y=51,z=426,dx=0,dz=0] run function ocarina_of_time:teleports/desert_colossus/grotto/inside
execute if entity @s[x=437,y=34,z=430,dx=0,dz=0] run function ocarina_of_time:teleports/desert_colossus/grotto/outside
