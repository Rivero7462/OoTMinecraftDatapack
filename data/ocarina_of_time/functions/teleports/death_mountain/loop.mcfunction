...
#Goron City
execute if entity @s[x=2028,y=106,z=1418,dx=2,dz=0] run function ocarina_of_time:teleports/death_mountain/goron_city/to
execute if entity @s[x=2016,y=102,z=1420,dx=0,dz=0] run function ocarina_of_time:teleports/death_mountain/goron_city/from
...
#Pit
execute if block ~ ~-2 ~ minecraft:black_concrete run function ocarina_of_time:teleports/death_mountain/pit

#Grotto 1
execute if entity @s[x=2025,y=118,z=1464,dx=0,dz=0] run function ocarina_of_time:teleports/death_mountain/grotto_1/inside
execute if entity @s[x=2022,y=68,z=1481,dx=0,dz=0] run function ocarina_of_time:teleports/death_mountain/grotto_1/outside

#Grotto 2
execute if entity @s[x=2029,y=107,z=1432,dx=0,dz=0] run function ocarina_of_time:teleports/death_mountain/grotto_2/inside
execute if entity @s[x=2020,y=69,z=1451,dx=0,dz=0] run function ocarina_of_time:teleports/death_mountain/grotto_2/outside
