...
#Fairy Fountain
execute if entity @s[x=1536,y=78,z=2310,dx=0,dz=0] run function ocarina_of_time:teleports/zora_river/fairy_fountain/inside
execute if entity @s[x=1491,y=49,z=2306,dx=0,dz=0] run function ocarina_of_time:teleports/zora_river/fairy_fountain/outside

#Grotto 1
execute if entity @s[x=1481,y=66,z=2314,dx=0,dz=0] run function ocarina_of_time:teleports/zora_river/grotto_1/inside
execute if entity @s[x=1470,y=51,z=2341,dx=0,dz=0] run function ocarina_of_time:teleports/zora_river/grotto_1/outside

#Grotto 2
execute if entity @s[x=1526,y=78,z=2323,dx=0,dz=0] run function ocarina_of_time:teleports/zora_river/grotto_2/inside
execute if entity @s[x=1500,y=51,z=2343,dx=0,dz=0] run function ocarina_of_time:teleports/zora_river/grotto_2/outside
