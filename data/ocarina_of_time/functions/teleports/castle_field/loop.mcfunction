...
execute if entity @s[x=947,y=74,z=944,dx=0,dz=1] run function ocarina_of_time:teleports/castle_field/great_fairy_fountain/inside
execute if entity @s[x=945,y=73,z=996,dx=4,dz=0] run function ocarina_of_time:teleports/castle_field/great_fairy_fountain/outside

#Grotto
execute if entity @s[x=925,y=84,z=903,dx=0,dz=0] run function ocarina_of_time:teleports/castle_field/grotto/inside
execute if entity @s[x=925,y=58,z=916,dx=0,dz=0] run function ocarina_of_time:teleports/castle_field/grotto/outside
