execute if entity @s[nbt={Inventory:[{tag:{Fairy:1b}}]}] unless entity @s[nbt={Inventory:[{id:"minecraft:glass_bottle"}]}] run effect give @a minecraft:instant_health 1 20 true
...
execute if entity @s[scores={UseItem=1..}] if entity @s[nbt={SelectedItem:{tag:{BottledFairy:1b}}}] run effect give @a minecraft:instant_health 1 20 true
