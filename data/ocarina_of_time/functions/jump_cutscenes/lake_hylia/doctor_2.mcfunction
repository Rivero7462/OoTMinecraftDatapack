execute unless entity @a[scores={click=0..}] run tp @a 1368 56 2670
...
execute unless entity @a[scores={click=0..}] run fill 1367 57 2670 1367 57 2670 minecraft:barrier
execute unless entity @a[scores={click=0..}] run fill 1368 57 2671 1368 57 2671 minecraft:barrier
execute unless entity @a[scores={click=0..}] run fill 1368 57 2669 1368 57 2669 minecraft:barrier
execute unless entity @a[scores={click=0..}] run fill 1369 57 2670 1369 57 2670 minecraft:barrier
...
execute if entity @a[scores={click=18}] run fill 1369 57 2671 1367 57 2669 minecraft:air

execute if entity @a[scores={click=18}] run tag @a add TimedRace
execute if entity @a[scores={click=18}] run tag @a add TimedRace3
execute if entity @a[scores={click=18}] run tag @a remove GiveFrog2
