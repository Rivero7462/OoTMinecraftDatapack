...
execute if entity @s[nbt={HurtTime:10s}] if entity @s[scores={timer=10..}] run tag @e[type=armor_stand,tag=GanonBody] add Final
execute if entity @s[nbt={HurtTime:10s}] if entity @s[scores={timer=10..}] run scoreboard players set @s timer 0
