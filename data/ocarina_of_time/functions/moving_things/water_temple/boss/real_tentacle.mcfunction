...
execute unless entity @s[tag=Shake] if entity @s[scores={timer=297..}] run kill @s

#Grab
execute if entity @s[scores={timer=90..}] positioned ^ ^ ^2.5 if entity @a[distance=..1.2] run tag @s add Shake
execute if entity @s[scores={timer=90..}] positioned ^ ^ ^1 if entity @a[distance=..1.2] run tag @s add Shake
execute if entity @s[scores={timer=90..}] positioned ^ ^ ^ if entity @a[distance=..1.2] run tag @s add Shake
execute if entity @s[scores={timer=90..}] positioned ^ ^ ^-1 if entity @a[distance=..1.2] run tag @s add Shake
...
execute if entity @s[scores={lifetime=1}] as @e[type=zombie,tag=ShakeTentacle] at @s rotated as @e[type=armor_stand,tag=RealTentacle] run tp @s ~ ~ ~ ~ -90
execute if entity @s[scores={lifetime=2..}] run kill @s

#Sounds
execute if entity @s[scores={timer=85}] run stopsound @a hostile minecraft:ambient.underwater.loop
