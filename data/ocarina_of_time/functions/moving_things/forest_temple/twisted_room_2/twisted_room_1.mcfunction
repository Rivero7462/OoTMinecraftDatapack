...
execute if entity @s[scores={lifetime=1}] run fill 935 87 -1154 935 87 -1154 minecraft:white_shulker_box
...
execute if entity @s[scores={lifetime=70}] run fill 937 85 -1191 937 85 -1191 minecraft:redstone_block
execute if entity @s[scores={lifetime=70}] run fill 957 85 -1176 957 85 -1176 minecraft:gold_block
