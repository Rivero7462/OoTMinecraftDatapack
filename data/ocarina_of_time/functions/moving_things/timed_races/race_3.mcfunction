execute unless entity @s[scores={RaceTime=..3500}] run scoreboard players set @s RaceTime 3500
scoreboard objectives setdisplay sidebar RaceTime
tag @a add HideDisplayScore

execute if entity @s[scores={RaceTime=..3500}] run scoreboard players remove @s RaceTime 1

execute if entity @s[scores={RaceTime=..0}] run tag @a add Prescription
execute if entity @s[scores={RaceTime=..0}] run clear @a minecraft:shears{Eyedrops:1b}
...
execute if entity @s[scores={RaceTime=..0}] run tag @s remove TimedRace3
